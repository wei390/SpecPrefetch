...
Metrics:
  - Recall@{3,6,8} for next-1 and next-2 predictions
  - Exact match@6 for next-1 and next-2 predictions
...
class MultiTopKAccumulator:
    """Accumulate recall@{3,6,8} and exact@6 for next-1 and next-2."""
    n_tokens: int = 0
