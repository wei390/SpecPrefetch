...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--future_expert_predictor_horizons", type=str, default="1",
        help="Comma-separated future horizons. Only horizon=1 is supported in this build.",
    )
...
def main() -> None:
    ...
    if _is_master():
        ...
        logger.info(
            ...
            "kl_next1=%s fusion_mode=%s init_alpha=%s lora_rank=%s",
