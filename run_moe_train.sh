...
FUTURE_EXPERT_PREDICTOR_HORIZONS="${FUTURE_EXPERT_PREDICTOR_HORIZONS:-1,2}"
FUTURE_EXPERT_COEF_NEXT1="${FUTURE_EXPERT_COEF_NEXT1:-2.0}"
FUTURE_EXPERT_COEF_NEXT2="${FUTURE_EXPERT_COEF_NEXT2:-1.0}"
...
echo "PREDICTOR KL_COEF next1=$FUTURE_EXPERT_COEF_NEXT1 next2=$FUTURE_EXPERT_COEF_NEXT2"
...
CMD=(
  ...
  --future_expert_predictor_kl_coef_next2 "$FUTURE_EXPERT_COEF_NEXT2"
